describe('Blog app', function () {
    ...
    describe('when logged in', function () {
        ...
        it('blogs are displayed in order of likes,', function () {
            cy.createBlog({
                title: 'This should be 2',
                author: 'Second',
                url: 'www.b.com',
                likes: 60,
            })
            cy.createBlog({
                title: 'This should be 1',
                author: 'First',
                url: 'www.a.com',
                likes: 80,
            })
            cy.createBlog({
                title: 'This should be 4',
                author: 'Fourth',
                url: 'www.d.com',
                likes: 10,
            })
            cy.createBlog({
                title: 'This should be 3',
                author: 'Third',
                url: 'www.c.com',
                likes: 30,
            })
